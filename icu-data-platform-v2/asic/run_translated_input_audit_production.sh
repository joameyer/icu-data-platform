...
#
# This job is read-only with respect to pooled, translated, cleaned, and derived
# data. It writes only an aggregate audit report and Slurm logs.
#SBATCH --job-name=asic_audit_translated
...
echo "[$(date --iso-8601=seconds)] Starting ASIC translated-input production audit"
...
echo "[$(date --iso-8601=seconds)] ASIC translated-input production audit finished"
echo "Review the translated_input_audit report under ${project_root}/asic/reports/production/"
